...
void Byte_Write_To_APROM(void)
{
    if (FlashSaveFlag)
    {
        ...
        /* Write count down hour to 0x0204 */
        IAPCN		= APROM_WRITE;
        IAPAH		= 0x02;
        IAPAL		= 0x04;
        IAPFD		= ChkSumH;	
        ...
        /* Write count down hour to 0x0205 */
        IAPCN		= APROM_WRITE;
        IAPAH		= 0x02;
        IAPAL		= 0x05;
        IAPFD		= ChkSumL;	
        ...
        /* Write count down hour to 0x0206 */
        IAPCN		= APROM_WRITE;
        IAPAH		= 0x02;
        IAPAL		= 0x06;
        IAPFD		= PowerOnNum;	
        ...
        /* Write count down hour to 0x0207 */
        IAPCN		= APROM_WRITE;
        IAPAH		= 0x02;
        IAPAL		= 0x07;
        IAPFD		= MotorData.ModeBuf;	
        TA			= 0xAA;
        TA			= 0x55;
        IAPTRG	|= BIT0;			// Start IAP
